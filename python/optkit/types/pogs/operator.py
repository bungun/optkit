...
# 			# 	elif os.path.exists(os.path.join(directory, 'LLT.npy')):
...
# 			# 	elif os.path.exists(os.path.join(directory, 'd.npy')):
...
# 			# 	elif os.path.exists(os.path.join(directory, 'e.npy')):
...
# 			# 		raise ValueError('specified fileos.path already exists '
