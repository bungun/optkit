...
oklib.__vector_memcpy_va.argtypes=[vector_p, ok_float_p, c_size_t]
oklib.__vector_memcpy_av.argtypes=[ok_float_p, vector_p, c_size_t]
...
oklib.__matrix_memcpy_ma.argtypes=[matrix_p, ok_float_p, c_uint]
oklib.__matrix_memcpy_am.argtypes=[ok_float_p, matrix_p, c_uint]
